...
<head>
  ...
  <link rel="stylesheet" href="{{asset('ressources/vendor/bootstrap-icons/font/bootstrap-icons.css')}}">
  <link rel="stylesheet" href="{{asset('ressources/vendor/daterangepicker/daterangepicker.css')}}">
  <link rel="stylesheet" href="{{asset('ressources/vendor/tom-select/dist/css/tom-select.bootstrap5.css')}}">

  <!-- CSS Front Template -->

  <link rel="preload" href="{{asset('ressources/css/theme.min.css')}}" data-hs-appearance="default" as="style">
  <link rel="preload" href="{{asset('ressources/css/theme-dark.min.css')}}" data-hs-appearance="dark" as="style">
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
  ...
  <script src="{{asset('ressources/js/hs.theme-appearance.js')}}"></script>
  <script src="{{asset('ressources/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js')}}"></script>
  <!-- ========== HEADER ========== -->
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a class="nav-link dropdown-toggle " href="#navbarVerticalMenuPagesUsersMenu" role="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuPagesUsersMenu" aria-expanded="false" aria-controls="navbarVerticalMenuPagesUsersMenu">
                  ...
                  <span class="nav-link-title">Emploi</span>
                </a>

                <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                  <a class="nav-link " href="{{route('job.add')}}">Nouveau emploi</a>
                  <a class="nav-link " href="./users-leaderboard.html">Liste des emplois</a>
                  <a class="nav-link " href="./users-add-user.html">Programmer mes Offres <span class="badge bg-info rounded-pill ms-1">Hot</span></a>
                </div>
              </div>
              <!-- End Collapse -->
                  ...
                  <div id="navbarVerticalMenuPagesMenuEcommerce">
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuPagesEcommerceProductsMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                        ...
                        <a class="nav-link " href="./ecommerce-add-product.html">Programmer les</a>
                      </div>
                    </div>
                    <!-- End Collapse -->
  ...
  <script src="{{asset('ressources/vendor/jquery/dist/jquery.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/jquery-migrate/dist/jquery-migrate.js')}}"></script>
  <script src="{{asset('ressources/vendor/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>

  <!-- JS Implementing Plugins -->
  <script src="{{asset('ressources/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/hs-form-search/dist/hs-form-search.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/chart.js/dist/chart.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js')}}"> </script>
  <script src="{{asset('ressources/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/daterangepicker/moment.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/daterangepicker/daterangepicker.js')}}"></script>
  <script src="{{asset('ressources/vendor/tom-select/dist/js/tom-select.complete.min.js')}}"></script>
  <script src="{{asset('ressources/vendor/clipboard/dist/clipboard.min.js')}}"></script>>
  <script src="{{asset('ressources/vendor/datatables/media/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('ressources/vendor/datatables.net.extensions/select/select.min.js')}}"></script>
  <!-- JS Front -->
  <script src="{{asset('ressources/js/theme.min.js')}}"> </script>
  <script src="{{asset('ressources/js/hs.theme-appearance-charts.js')}}"></script>
