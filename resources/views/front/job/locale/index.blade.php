...
<div class="row align-items-center">
    ...
    @foreach ($ressourcelocale as  $value)
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
        <div class="jbr-wrap text-left border rounded">
            <div class="cats-box mlb-res rounded bg-white d-flex align-items-center justify-content-between px-3 py-3">
                ...
                <div class="text-center mlb-last"><a href="{{route('detail.job', $value->slug)}}" class="btn gray ft-medium apply-btn fs-sm rounded">Detail<i class="lni lni-arrow-right-circle ml-1"></i></a></div>
            </div>
        </div>
    </div>
    @endforeach
